...
def inference(
    ...
    if cfg.TEST.RE_RANKING == 'no':
        ...
        if with_arm:
            evaluator = create_supervised_evaluator(model, metrics={
                'r1_mAP': R1_mAP_arm(num_query, max_rank=50, feat_norm=cfg.TEST.FEAT_NORM)},
    ...
    # visualize_ranked_results(    ,data_type="image", save_dir=osp.join(osp.split(cfg.TEST.WEIGHT), 'visrank'))
