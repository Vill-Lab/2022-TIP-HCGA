...
# DeepFeatureClustering
_C.DFC = CN()
_C.DFC.MODE = 'sp'
_C.DFC.EPOCH = 2**6
_C.DFC.MODIM1 = 64
_C.DFC.MODIM2 = 32
_C.DFC.MIN_LABEL_NUM = 4
_C.DFC.MAX_LABEL_NUM = 256

_C.DFC.COEF = 0.04
_C.DFC.PIXEL_WEIGHT = 0.1
_C.DFC.IMAGE_WEIGHT = 0.1
_C.DFC.DIAG_WEIGHT = 0.0
_C.DFC.CENTER_WEIGHT = 0.0
_C.DFC.SPATIAL = 1
_C.DFC.C_LOSS = 'l1'
_C.DFC.LR = 'structure'

_C.DFC.VISULIZE = False
...
_C.VIS.PORT = 8097
_C.VIS.WIN_SIZE = 256
_C.VIS.ENV = 'HumanCo-parsing'
_C.VIS.SINGLE_PANE = 1
...
_C.INPUT.SIM_OCCLUD = 0
_C.INPUT.OCCLUD_MODE ='random_earse'
...
_C.DATASETS.ROOT_DIR = ('/mnt/Data/dsg/HPNet/dataset')
...
_C.SOLVER.CrossE_G_WEIGHT = 1
_C.SOLVER.CrossE_F_WEIGHT = 1
_C.SOLVER.CrossE_P_WEIGHT = 1
_C.SOLVER.Tri_G_WEIGHT = 1
_C.SOLVER.Tri_F_WEIGHT = 0
