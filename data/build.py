...
def make_data_loader(cfg):
    ...
    if len(cfg.DATASETS.NAMES) == 1:
        dataset = init_dataset(cfg.DATASETS.NAMES, pseudo_label_subdir=cfg.DATASETS.PSEUDO_LABEL_SUBDIR,
                               part_num=cfg.CLUSTERING.PART_NUM, root=cfg.DATASETS.ROOT_DIR)
    else:
